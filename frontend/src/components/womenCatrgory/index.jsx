...
import { getProductByCategory } from "../../redux/products/products.action";
/**
...
export default function WomenCategory({ name }) {
  ...
  useEffect(() => {
    disptach(getProductByCategory("Women"));
  }, [disptach]);
    ...
    <div className={classes.categorymain}>
      <div className={classes.mainGrid}>
        <Box className={classes.headingContainer}>
          <Typography className="heading1"> Women CATEgORy</Typography>
